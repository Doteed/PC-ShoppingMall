...
CREATE TABLE QA (
    ...
    "CONTENT" VARCHAR2(3000) NOT NULL,
    "DATE" DATE NOT NULL,
    "ANSWER_STATUS" VARCHAR2(20) DEFAULT '답변대기' NOT NULL, -- 답변 상태
...
-- QA_ANSWER TABLE QA 답변 저장 테이블
CREATE TABLE QA_ANSWER (
    "ANSWER_ID" NUMBER PRIMARY KEY,
    "QA_ID" NUMBER NOT NULL,
    "ANSWER_CONTENT" VARCHAR2(3000),
    "ANSWER_DATE" DATE,
    FOREIGN KEY ("QA_ID") REFERENCES "QA"("QA_ID") ON DELETE CASCADE,
    CONSTRAINT unique_qa_id UNIQUE ("QA_ID") 
);

CREATE SEQUENCE SEQ_QA_ANSWER NOCACHE;
