...
INSERT INTO "PRODUCT" ("PRODUCT_ID", "USER_ID", "CATEGORY_ID_1", "CATEGORY_ID_2", "CATEGORY_ID_3", "AUTH_ID", "P_PRICE", "P_NAME", "P_STOCK", "P_REPORTSTOCK", "P_ENROLL", "IMAGE_URL", "P_EXPLAN", "P_SALE", "P_SOLDOUT", "ORDER_WAITING", "AVAILABLE_STOCK")
VALUES (SEQ_PRODUCT.NEXTVAL, 'user01', 3, NULL, NULL, 2, 94910, 'darkFlash NEBULA DN-360D ARGB (화이트)', 30, 5, TIMESTAMP'2025-01-07 10:03:41', 'http://localhost:8080/images/product/cooler/cooler13.png', 'DarkFlash의 쿨러.', 'Y', 'N', 0, 30);
...
INSERT INTO "PRODUCT" ("PRODUCT_ID", "USER_ID", "CATEGORY_ID_1", "CATEGORY_ID_2", "CATEGORY_ID_3", "AUTH_ID", "P_PRICE", "P_NAME", "P_STOCK", "P_REPORTSTOCK", "P_ENROLL", "IMAGE_URL", "P_EXPLAN", "P_SALE", "P_SOLDOUT", "ORDER_WAITING", "AVAILABLE_STOCK")
VALUES (SEQ_PRODUCT.NEXTVAL, 'user01', 4, NULL, NULL, 2, 52800, 'darkFlash DS900 ARGB 강화유리 (블랙)', 20, 5, TIMESTAMP'2025-01-07 10:03:41', 'http://localhost:8080/images/product/case/case43.png', 'darkFlash의 케이스.', 'Y', 'N', 0, 20);
...
-- CART
INSERT INTO CART (CART_ID, USER_ID, PRODUCT_ID, QUANTITY, CART_DATE, SELECTED) VALUES 
    (1, 'user01', 1, 1, TIMESTAMP '2025-01-01 15:24:25', 'N');
INSERT INTO CART (CART_ID, USER_ID, PRODUCT_ID, QUANTITY, CART_DATE, SELECTED) VALUES 
    (2, 'user01', 2, 1, TIMESTAMP '2025-01-01 15:24:25', 'N');
INSERT INTO CART (CART_ID, USER_ID, PRODUCT_ID, QUANTITY, CART_DATE, SELECTED) VALUES 
    (3, 'user01', 3, 2, TIMESTAMP '2025-01-04 09:18:29', 'N');
INSERT INTO CART (CART_ID, USER_ID, PRODUCT_ID, QUANTITY, CART_DATE, SELECTED) VALUES 
    (4, 'user02', 1, 1, TIMESTAMP '2025-01-04 09:18:29', 'N');
INSERT INTO CART (CART_ID, USER_ID, PRODUCT_ID, QUANTITY, CART_DATE, SELECTED) VALUES 
    (5, 'user02', 4, 1, TIMESTAMP '2025-01-10 11:23:47', 'N');
INSERT INTO CART (CART_ID, USER_ID, PRODUCT_ID, QUANTITY, CART_DATE, SELECTED) VALUES 
    (6, 'user02', 5, 2, TIMESTAMP '2025-01-14 13:34:32', 'N');
INSERT INTO CART (CART_ID, USER_ID, PRODUCT_ID, QUANTITY, CART_DATE, SELECTED) VALUES 
    (7, 'user01', 6, 1, TIMESTAMP '2025-01-14 13:34:32', 'N');

-- DELIVERY
INSERT INTO DELIVERY (DELIVERY_ID, ADDRESSEE, ADDRESS, PHONE, DELIVERY_STATUS) VALUES 
    (1, '김민수', '서울시 강남구 테헤란로 123', '010-4444-4444', '배송완료');
INSERT INTO DELIVERY (DELIVERY_ID, ADDRESSEE, ADDRESS, PHONE, DELIVERY_STATUS) VALUES 
    (2, '김민수', '서울시 강남구 테헤란로 123', '010-4444-4444', '입금대기');
INSERT INTO DELIVERY (DELIVERY_ID, ADDRESSEE, ADDRESS, PHONE, DELIVERY_STATUS) VALUES 
    (3, '김민수', '서울시 강남구 테헤란로 123', '010-4444-4444', '배송중');
INSERT INTO DELIVERY (DELIVERY_ID, ADDRESSEE, ADDRESS, PHONE, DELIVERY_STATUS) VALUES 
    (4, '박지연', '서울 동대문구 안암로 6', '010-5555-5555', '결제완료');
INSERT INTO DELIVERY (DELIVERY_ID, ADDRESSEE, ADDRESS, PHONE, DELIVERY_STATUS) VALUES 
    (5, '박지연', '서울 동대문구 안암로 6', '010-5555-5555', '배송중');
INSERT INTO DELIVERY (DELIVERY_ID, ADDRESSEE, ADDRESS, PHONE, DELIVERY_STATUS) VALUES 
    (6, '박지연', '서울 동대문구 안암로 6', '010-5555-5555', '취소');

-- ORDER_TABLE
INSERT INTO ORDER_TABLE (ORDER_ID, DELIVERY_ID, USER_ID, AUTH_ID, PRODUCT_ID, TOTAL_PRICE, PAYMENT_METHOD, ORDER_DATE) VALUES 
    (1, 1, 'user01', 1, 1, 106000, '신용카드', TIMESTAMP '2025-01-08 22:33:58');
INSERT INTO ORDER_TABLE (ORDER_ID, DELIVERY_ID, USER_ID, AUTH_ID, PRODUCT_ID, TOTAL_PRICE, PAYMENT_METHOD, ORDER_DATE) VALUES 
    (2, 2, 'user01', 1, 2, 240000, '무통장', TIMESTAMP '2025-01-08 22:33:58');
INSERT INTO ORDER_TABLE (ORDER_ID, DELIVERY_ID, USER_ID, AUTH_ID, PRODUCT_ID, TOTAL_PRICE, PAYMENT_METHOD, ORDER_DATE) VALUES 
    (3, 3, 'user01', 1, 3, 298000, '신용카드', TIMESTAMP '2025-01-10 15:09:12');
INSERT INTO ORDER_TABLE (ORDER_ID, DELIVERY_ID, USER_ID, AUTH_ID, PRODUCT_ID, TOTAL_PRICE, PAYMENT_METHOD, ORDER_DATE) VALUES 
    (4, 4, 'user02', 1, 1, 106000, '신용카드', TIMESTAMP '2025-01-11 13:35:48');
INSERT INTO ORDER_TABLE (ORDER_ID, DELIVERY_ID, USER_ID, AUTH_ID, PRODUCT_ID, TOTAL_PRICE, PAYMENT_METHOD, ORDER_DATE) VALUES 
    (5, 5, 'user02', 1, 4, 100000, '신용카드', TIMESTAMP '2025-01-11 13:35:48');
INSERT INTO ORDER_TABLE (ORDER_ID, DELIVERY_ID, USER_ID, AUTH_ID, PRODUCT_ID, TOTAL_PRICE, PAYMENT_METHOD, ORDER_DATE) VALUES 
    (6, 6, 'user02', 1, 5, 210980, '신용카드', TIMESTAMP '2025-01-11 13:35:48');
...
INSERT INTO REVIEW (REVIEW_ID, PRODUCT_ID, ORDER_ID, USER_ID, AUTH_ID, TITLE, CONTENT, "DATE", RATING, IS_DELETED) VALUES 
    (2, 2, 2, 'user01', 1, '진짜 별로임...', '배송도 완전 늦게오고 상자도 다 박살나서 왔음... 다행히 제품은 멀쩡하게 와서 2점드림', TIMESTAMP '2025-01-11 12:35:58', 2, 'N');
INSERT INTO REVIEW (REVIEW_ID, PRODUCT_ID, ORDER_ID, USER_ID, AUTH_ID, TITLE, CONTENT, "DATE", RATING, IS_DELETED) VALUES 
    (3, 1, 4, 'user02', 1, '좋아요', '좋아요좋아요좋아요좋아요좋아요', TIMESTAMP '2025-01-10 17:15:18', 4, 'N');
INSERT INTO REVIEW (REVIEW_ID, PRODUCT_ID, ORDER_ID, USER_ID, AUTH_ID, TITLE, CONTENT, "DATE", RATING, IS_DELETED) VALUES 
    (4, 4, 5, 'user02', 1, '가성비 좋아요', '이 스펙에 이 가격으로 사는건 말이 안됩니다 정말 좋은 가성비로 살 수 있어서 좋네요', TIMESTAMP '2025-01-07 13:45:38', 5, 'Y');
INSERT INTO REVIEW (REVIEW_ID, PRODUCT_ID, ORDER_ID, USER_ID, AUTH_ID, TITLE, CONTENT, "DATE", RATING, IS_DELETED) VALUES 
    (5, 5, 6, 'user02', 1, '만족합니다', '빠른 배송 일단 만족하고요 포장 상태도 안전하게 되어있고 제품도 이상없이 잘 작동하고 만족해요 다른 사람들한테 적극 추천할 수 있어요~^^', TIMESTAMP '2025-01-10 15:19:05', 2, 'Y');
